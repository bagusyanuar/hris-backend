...
type CompanyRepository interface {
	...
	// search kosong = tanpa filter; non-kosong = match legal_name ATAU nama branch milik company (tech-spec.md §6.1).
...
type BranchRepository interface {
	...
	// FindAllByCompanyIDs — batch, TANPA pagination, dipakai buat embed nested branches
	// di GET /companies (decision-log.md ADR-006). Jumlah branch per company diasumsikan kecil.
